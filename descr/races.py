...
def get_race_descr():
    ...
    elves_table = ("Ability score for INT of 9 or higher, CON of 17 or lower                    "
                   "--------------------------------------------------------------------------\n"
    ...
    dwarves_table = ("Ability score for CON of 9 or higher, CHA of 17 or lower                    "
                     "--------------------------------------------------------------------------\n"
                     ...
                     "--------------------------------------------------------------------------\n"
                     "- Darkvision 60'\n"
                     "- Detect new construction, shifting walls, slanting passages,\n"
                     "  traps w/ 1-2 on d6                                                        "
                     "--------------------------------------------------------------------------\n"
    ...
    halflings_table = ("Ability score for DEX of 9 or higher, STR of 17 or lower                    "
                       "--------------------------------------------------------------------------\n"
                       "Can be Cleric, Fighter or Thief                                             "
                       "--------------------------------------------------------------------------\n"
                       "d6 maximum Hit Die                                                          "
