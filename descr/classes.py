...
def get_class_descr():
    ...
    thief_table = ("Prime Requisite: DEX (Must be 9+)                                           "
                   "--------------------------------------------------------------------------\n"
                   "Hit Dice: d4                                                                "
                   "--------------------------------------------------------------------------\n"
                   "Any weapons                                                                 "
    ...
    fighter_magic_user_table = ("Prime Requisite: STR and INT (Both must be 9+)                              "
                                "--------------------------------------------------------------------------\n"
                                "Hit Dice: d6                                                                "
                                "--------------------------------------------------------------------------\n"
                                "Any weapons                                                                 "
    ...
    magic_user_thief_descr = ("The Magic-User/Thief is a cunning and elusive character, merging the arcane arts with the "
                              ...
                              "disposal.")
    magic_user_thief_table = ("Prime Requisite: STR and DEX (Both must be 9+)                              "
                              "--------------------------------------------------------------------------\n"
                              "Hit Dice: d4                                                                "
                              "--------------------------------------------------------------------------\n"
                              "Any weapons                                                                 "
