...
def get_class_descr():
    ...
    thief_table = ("Prime Requisite: DEX (Must be 9+)\n"
                   ...
                   "\n"
                   "Sneak Attack:\n"
                   "- +4 attack bonus and does double damage if it is successful. The attack must be from behind (may "
                   "require a Move Silently and/or Hide roll).\n"
                   "- Can't be performed on the same opponent more than once in any given combat.\n"
                   "- Can also be performed bare-handed and with the 'flat of the blade' (+0 attack bonus and does normal "
