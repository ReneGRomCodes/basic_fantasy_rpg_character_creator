...
from .screen_objects import Button, TextField, ProgressBar, InfoPanel, InteractiveText, TextInputField
...
def initialize_ui_registry(screen) -> dict:
    ...
    inactive_continue_button = Button(screen, "Continue", text_medium, text_color="inactive")
    ...
    skip_button: Button = Button(screen, "Skip", text_medium)
    back_button: Button = Button(screen, "Back", text_medium)
    reset_button: Button = Button(screen, "CLEAR SELECTION", text_medium)
    ...
    subtitle: TextField = TextField(screen, "Character Creator", text_large)
    copyright_notice: TextField = TextField(screen, "Basic Fantasy Role-Playing Game, Copyright 2006-2025 Chris "
                                                       "Gonnerman. All Rights reserved. Distributed under CC BY-SA license. "
                                                       "www.basicfantasy.com", text_small)
    title_progress_bar: ProgressBar = ProgressBar(screen)
    continue_to_main_menu: TextField = TextField(screen, "Press any key to continue", text_medium)


    # Main Menu.
    main_menu_screen_title: TextField = TextField(screen, "- MAIN MENU -", title_size)
    start_button: Button = Button(screen, "Create a Character", text_medium)
    load_char: Button = Button(screen, "Load Character", text_medium)
    settings_button: Button = Button(screen, "Settings", text_medium)
    credits_button: Button = Button(screen, "Credits", text_medium)
    quit_button: Button = Button(screen, "Quit", text_medium)
    ...
    ability_02_info: InfoPanel = InfoPanel(screen, ability_descr["dex_descr"], text_small, multi_line=True,
                                           surface_width=info_panel_width, pos="topright")
    ability_03_info: InfoPanel = InfoPanel(screen, ability_descr["con_descr"], text_small, multi_line=True,
                                           surface_width=info_panel_width, pos="topright")
    ability_04_info: InfoPanel = InfoPanel(screen, ability_descr["int_descr"], text_small, multi_line=True,
                                           surface_width=info_panel_width, pos="topright")
    ability_05_info: InfoPanel = InfoPanel(screen, ability_descr["wis_descr"], text_small, multi_line=True,
                                           surface_width=info_panel_width, pos="topright")
    ability_06_info: InfoPanel = InfoPanel(screen, ability_descr["cha_descr"], text_small, multi_line=True,
                                           surface_width=info_panel_width, pos="topright")
    # Ability text fields.
    ability_01_field: InteractiveText = InteractiveText(screen, "Strength", text_medium, panel=(ability_01_info, ))
    ability_02_field: InteractiveText = InteractiveText(screen, "Dexterity", text_medium, panel=(ability_02_info, ))
    ability_03_field: InteractiveText = InteractiveText(screen, "Constitution", text_medium, panel=(ability_03_info, ))
    ability_04_field: InteractiveText = InteractiveText(screen, "Intelligence", text_medium, panel=(ability_04_info, ))
    ability_05_field: InteractiveText = InteractiveText(screen, "Wisdom", text_medium, panel=(ability_05_info, ))
    ability_06_field: InteractiveText = InteractiveText(screen, "Charisma", text_medium, panel=(ability_06_info, ))


    # Race/class selection screen.
    # Screen layout is designed to adapt and fit up to 16 races/classes.
    race_class_selection_screen_title: TextField = TextField(screen, "- RACE / CLASS -", text_large)
    # Race info Panels.
    race_01_info: InfoPanel = InfoPanel(screen, race_descr["humans"][0], text_small, multi_line=True,
                                        surface_width=info_panel_width)
    race_01_info_table: InfoPanel = InfoPanel(screen, race_descr["humans"][1], text_small, multi_line=True,
                                              surface_width=info_panel_width, pos="right")
    race_02_info: InfoPanel = InfoPanel(screen, race_descr["elves"][0], text_small, multi_line=True,
                                        surface_width=info_panel_width)
    race_02_info_table: InfoPanel = InfoPanel(screen, race_descr["elves"][1], text_small, multi_line=True,
                                              surface_width=info_panel_width, pos="right")
    race_03_info: InfoPanel = InfoPanel(screen, race_descr["dwarves"][0], text_small, multi_line=True,
                                        surface_width=info_panel_width)
    race_03_info_table: InfoPanel = InfoPanel(screen, race_descr["dwarves"][1], text_small, multi_line=True,
                                              surface_width=info_panel_width, pos="right")
    race_04_info: InfoPanel = InfoPanel(screen, race_descr["halflings"][0], text_small, multi_line=True,
                                        surface_width=info_panel_width)
    race_04_info_table: InfoPanel = InfoPanel(screen, race_descr["halflings"][1], text_small, multi_line=True,
                                              surface_width=info_panel_width, pos="right")
    # Class info panels.
    class_01_info: InfoPanel = InfoPanel(screen, class_descr["fighter"][0], text_small, multi_line=True,
                                         surface_width=info_panel_width)
    class_01_info_table: InfoPanel = InfoPanel(screen, class_descr["fighter"][1], text_small, multi_line=True,
                                               surface_width=info_panel_width, pos="left")
    class_02_info: InfoPanel = InfoPanel(screen, class_descr["cleric"][0], text_small, multi_line=True,
                                         surface_width=info_panel_width)
    class_02_info_table: InfoPanel = InfoPanel(screen, class_descr["cleric"][1], text_small, multi_line=True,
                                               surface_width=info_panel_width, pos="left")
    class_03_info: InfoPanel = InfoPanel(screen, class_descr["magic-user"][0], text_small, multi_line=True,
                                         surface_width=info_panel_width)
    class_03_info_table: InfoPanel = InfoPanel(screen, class_descr["magic-user"][1], text_small, multi_line=True,
                                               surface_width=info_panel_width, pos="left")
    class_04_info: InfoPanel = InfoPanel(screen, class_descr["thief"][0], text_small, multi_line=True,
                                         surface_width=info_panel_width)
    class_04_info_table: InfoPanel = InfoPanel(screen, class_descr["thief"][1], text_small, multi_line=True,
                                               surface_width=info_panel_width, pos="left")
    class_05_info: InfoPanel = InfoPanel(screen, class_descr["fighter_magic-user"][0], text_small,
                                         multi_line=True, surface_width=info_panel_width)
    class_05_info_table: InfoPanel = InfoPanel(screen, class_descr["fighter_magic-user"][1], text_small,
                                               multi_line=True, surface_width=info_panel_width, pos="left")
    class_06_info: InfoPanel = InfoPanel(screen, class_descr["magic-user_thief"][0], text_small,
                                         multi_line=True, surface_width=info_panel_width)
    class_06_info_table: InfoPanel = InfoPanel(screen, class_descr["magic-user_thief"][1], text_small,
                                               multi_line=True, surface_width=info_panel_width, pos="left")
    # Active race/class text fields. Used when a race/class can be chosen in the race/class selection.
    race_01_field: InteractiveText = InteractiveText(screen, "Human", text_medium,
                                                     panel=(race_01_info,race_01_info_table), select=True)
    race_02_field: InteractiveText = InteractiveText(screen, "Elf", text_medium,
                                                     panel=(race_02_info, race_02_info_table), select=True)
    race_03_field: InteractiveText = InteractiveText(screen, "Dwarf", text_medium,
                                                     panel=(race_03_info, race_03_info_table), select=True)
    race_04_field: InteractiveText = InteractiveText(screen, "Halfling", text_medium,
                                                     panel=(race_04_info, race_04_info_table), select=True)
    class_01_field: InteractiveText = InteractiveText(screen, "Fighter", text_medium,
                                                      panel=(class_01_info, class_01_info_table), select=True)
    class_02_field: InteractiveText = InteractiveText(screen, "Cleric", text_medium,
                                                      panel=(class_02_info, class_02_info_table), select=True)
    class_03_field: InteractiveText = InteractiveText(screen, "Magic-User", text_medium,
                                                      panel=(class_03_info, class_03_info_table), select=True)
    class_04_field: InteractiveText = InteractiveText(screen, "Thief", text_medium,
                                                      panel=(class_04_info, class_04_info_table), select=True)
    class_05_field: InteractiveText = InteractiveText(screen, "Fighter/Magic-User", text_medium,
                                                      panel=(class_05_info, class_05_info_table), select=True)
    class_06_field: InteractiveText = InteractiveText(screen, "Magic-User/Thief", text_medium,
    ...
    race_01_inactive_field: TextField = TextField(screen, "Human", text_medium, text_color="inactive")
    race_02_inactive_field: TextField = TextField(screen, "Elf", text_medium, text_color="inactive")
    race_03_inactive_field: TextField = TextField(screen, "Dwarf", text_medium, text_color="inactive")
    race_04_inactive_field: TextField = TextField(screen, "Halfling", text_medium, text_color="inactive")
    class_01_inactive_field: TextField = TextField(screen, "Fighter", text_medium, text_color="inactive")
    class_02_inactive_field: TextField = TextField(screen, "Cleric", text_medium, text_color="inactive")
    class_03_inactive_field: TextField = TextField(screen, "Magic-User", text_medium, text_color="inactive")
    class_04_inactive_field: TextField = TextField(screen, "Thief", text_medium, text_color="inactive")
    class_05_inactive_field: TextField = TextField(screen, "Fighter/Magic-User", text_medium, text_color="inactive")
    class_06_inactive_field: TextField = TextField(screen, "Magic-User/Thief", text_medium, text_color="inactive")
    ...
    spell_01_info: InfoPanel = InfoPanel(screen, spell_descr["read_magic"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_02_info: InfoPanel = InfoPanel(screen, spell_descr["charm_person"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_03_info: InfoPanel = InfoPanel(screen, spell_descr["detect_magic"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_04_info: InfoPanel = InfoPanel(screen, spell_descr["floating_disc"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_05_info: InfoPanel = InfoPanel(screen, spell_descr["hold_portal"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_06_info: InfoPanel = InfoPanel(screen, spell_descr["light"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_07_info: InfoPanel = InfoPanel(screen, spell_descr["magic_missile"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_08_info: InfoPanel = InfoPanel(screen, spell_descr["magic_mouth"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_09_info: InfoPanel = InfoPanel(screen, spell_descr["protection_from_evil"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_10_info: InfoPanel = InfoPanel(screen, spell_descr["read_languages"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_11_info: InfoPanel = InfoPanel(screen, spell_descr["shield"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_12_info: InfoPanel = InfoPanel(screen, spell_descr["sleep"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    spell_13_info: InfoPanel = InfoPanel(screen, spell_descr["ventriloquism"], text_small, multi_line=True,
                                         surface_width=info_panel_width, pos="right")
    # Selectable spell fields.
    spell_01_field: InteractiveText = InteractiveText(screen, "Read Magic", text_medium, panel=(spell_01_info,), select=True)
    spell_02_field: InteractiveText = InteractiveText(screen, "Charm Person", text_medium, panel=(spell_02_info, ), select=True)
    spell_03_field: InteractiveText = InteractiveText(screen, "Detect Magic", text_medium, panel=(spell_03_info, ), select=True)
    spell_04_field: InteractiveText = InteractiveText(screen, "Floating Disc", text_medium, panel=(spell_04_info, ), select=True)
    spell_05_field: InteractiveText = InteractiveText(screen, "Hold Portal", text_medium, panel=(spell_05_info, ), select=True)
    spell_06_field: InteractiveText = InteractiveText(screen, "Light *", text_medium, panel=(spell_06_info, ), select=True)
    spell_07_field: InteractiveText = InteractiveText(screen, "Magic Missile", text_medium, panel=(spell_07_info, ), select=True)
    spell_08_field: InteractiveText = InteractiveText(screen, "Magic Mouth", text_medium, panel=(spell_08_info, ), select=True)
    spell_09_field: InteractiveText = InteractiveText(screen, "Protection from Evil *", text_medium, panel=(spell_09_info, ), select=True)
    spell_10_field: InteractiveText = InteractiveText(screen, "Read Languages", text_medium, panel=(spell_10_info, ), select=True)
    spell_11_field: InteractiveText = InteractiveText(screen, "Shield", text_medium, panel=(spell_11_info, ), select=True)
    spell_12_field: InteractiveText = InteractiveText(screen, "Sleep", text_medium, panel=(spell_12_info, ), select=True)
    spell_13_field: InteractiveText = InteractiveText(screen, "Ventriloquism", text_medium, panel=(spell_13_info, ), select=True)
    ...
    language_03_field: InteractiveText = InteractiveText(screen, "Dwarvish", text_medium, select=True)
    language_04_field: InteractiveText = InteractiveText(screen, "Halfling", text_medium, select=True)
    ...
    # NOTE: every instance has to have the same 'text' attribute as their active counterpart.
    language_01_field_inactive: TextField = TextField(screen, "Common", text_medium, text_color="inactive")
    language_02_field_inactive: TextField = TextField(screen, "Elvish", text_medium, text_color="inactive")
    language_03_field_inactive: TextField = TextField(screen, "Dwarvish", text_medium, text_color="inactive")
    language_04_field_inactive: TextField = TextField(screen, "Halfling", text_medium, text_color="inactive")
    ...
    character_naming_prompt: TextField = TextField(screen, "", text_large)
    ...
    character_name_field: TextInputField = TextInputField(screen, character_name_input, int(screen_width/2))


    # Starting money screen.
    starting_money_screen_title: TextField = TextField(screen, "- STARTING MONEY -", text_large)
    # Choice buttons.
    ...
    random_money_field: TextField = TextField(screen, "You receive", text_medium)
    # 'pygame_textinput' and 'TextInputField' instances.
    money_input_prompt: TextField = TextField(screen, "Enter amount of gold for your character", text_medium)
